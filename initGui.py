...
NatronGui.natron.addMenuCommand('Tools/Time/Change Node FPS','nodeChangeFPS()')
NatronGui.natron.addMenuCommand('Tools/Time/Change Node Frame Range','nodeChangeFrameRange()')
