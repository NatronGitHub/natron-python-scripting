...
from Python_GUI.connectNodesReverse.connectNodesReverse import *
...
NatronGui.natron.addMenuCommand('Tools/Node Graph/Connect nodes reverse','connectNodesReverse', QtCore.Qt.Key.Key_Y, QtCore.Qt.KeyboardModifier.AltModifier)
