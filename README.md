...
- **[flipbook](/Python_GUI/flipbook/README.md)** : Creates and process a 'Write' node for the selected node, and send the result to an external image sequence viewer. (Win/Linux)
