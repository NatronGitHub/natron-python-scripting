...
- **[flipbook](/Python_GUI/flipbook/README.md)** : Creates and process a 'Write' node for the selected node, and send the result to an external image sequence viewer. (Windows/Linux only as of 11.06.2019)
